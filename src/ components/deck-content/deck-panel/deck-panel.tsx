...
import { DropdownItemWithIcon } from "../../ui/dropdown/dropdown-items/dropdow-item.tsx";
    ...
    <>
      ...
      <div>
        <div className={s.titleAndButton}>
          ...
          {isAuthor ? (
            <Button onClick={() => setAddNewCardModalIsOpen(true)}>
              Add New Card
            </Button>
          ) : (
...
type Props = {
  ...
  createCard: (args: CreateCardDto) => Promise<never>;
